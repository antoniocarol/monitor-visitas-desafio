...
const headerBtnClass = "flex items-center gap-2 rounded-lg bg-white/10 px-3 py-2 text-sm font-medium text-white/80 transition-colors hover:bg-white/20 hover:text-white";
...
export default function Home(): React.JSX.Element {
  ...
  const handleRegisterVisit = async (userId: number) => {
    try {
